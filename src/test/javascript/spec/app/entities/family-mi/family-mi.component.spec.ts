...
import { FamilyMiComponent } from 'app/entities/family-mi/family-mi.component';
...
describe('Component Tests', () => {
    describe('FamilyMi Management Component', () => {
        let comp: FamilyMiComponent;
        let fixture: ComponentFixture<FamilyMiComponent>;
        let service: FamilyMiService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [MinisteringTestModule],
                declarations: [FamilyMiComponent],
                providers: [
                    {
                ...
                .overrideTemplate(FamilyMiComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(FamilyMiComponent);
