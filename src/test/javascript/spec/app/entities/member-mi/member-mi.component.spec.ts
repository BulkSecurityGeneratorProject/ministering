...
import { MemberMiComponent } from 'app/entities/member-mi/member-mi.component';
...
describe('Component Tests', () => {
    describe('MemberMi Management Component', () => {
        let comp: MemberMiComponent;
        let fixture: ComponentFixture<MemberMiComponent>;
        let service: MemberMiService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [MinisteringTestModule],
                declarations: [MemberMiComponent],
                providers: [
                    {
                ...
                .overrideTemplate(MemberMiComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(MemberMiComponent);
