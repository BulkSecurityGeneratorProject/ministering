...
public class MemberResourceIntTest {
    ...
    private static final FamilyType DEFAULT_TYPE = FamilyType.INFANT;
    private static final FamilyType UPDATED_TYPE = FamilyType.PRIMARY;
     ...
     *
     * @see com.dqr.ministering.repository.search.MemberSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final MemberResource memberResource = new MemberResource(memberRepository, mockMemberSearchRepository);
