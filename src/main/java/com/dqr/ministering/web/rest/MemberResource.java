...
import com.dqr.ministering.repository.MemberRepository;
import com.dqr.ministering.repository.search.MemberSearchRepository;
...
public class MemberResource {
    ...
    public MemberResource(MemberRepository memberRepository, MemberSearchRepository memberSearchRepository) {
    ...
    public ResponseEntity<List<Member>> searchMembers(@RequestParam String query, Pageable pageable) {
        ...
        Page<Member> page = memberSearchRepository.search(queryStringQuery(query), pageable);
