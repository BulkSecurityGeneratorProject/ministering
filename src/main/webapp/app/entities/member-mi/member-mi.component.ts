...
@Component({
    selector: 'jhi-member-mi',
    templateUrl: './member-mi.component.html'
})
export class MemberMiComponent implements OnInit, OnDestroy {
    members: IMemberMi[];
    currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.memberService
                ...
                .subscribe(
                    (res: HttpResponse<IMemberMi[]>) => this.paginateMembers(res.body, res.headers),
    ...
    trackId(index: number, item: IMemberMi) {
        return item.id;
    }
    ...
    private paginateMembers(data: IMemberMi[], headers: HttpHeaders) {
