...
@Component({
    selector: 'jhi-family-mi',
    templateUrl: './family-mi.component.html'
})
export class FamilyMiComponent implements OnInit, OnDestroy {
    families: IFamilyMi[];
    currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.familyService
                ...
                .subscribe(
                    (res: HttpResponse<IFamilyMi[]>) => this.paginateFamilies(res.body, res.headers),
    ...
    trackId(index: number, item: IFamilyMi) {
        return item.id;
    }
    ...
    private paginateFamilies(data: IFamilyMi[], headers: HttpHeaders) {
